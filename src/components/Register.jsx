...
export default function Register({}) {
  ...
  if (loading)
    ...
    return (
      <div className="flex h-screen w-full flex-col items-center overflow-y-auto md:h-full md:p-0">
        ...
        <div className="mt-6 flex w-[90%] flex-col gap-10 md:w-[450px]">
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormDescription>
                        ...
                        even if this accout is for a business. a pet, or
                        something else.
                      </FormDescription>
